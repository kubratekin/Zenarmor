...
//                    driver = new ChromeDriver(new ChromeOptions().setHeadless(true));
    ...
    public static void selectCanvasArea(int xCanvas, int yCanvas, int xTarget, int yTarget) {
        action.moveToElement(driver.findElement(By.cssSelector(".au-target.chartjs-render-monitor[ref='canvas'][au-target-id='1215']")), xCanvas, yCanvas) //(300,300)
                .clickAndHold()
